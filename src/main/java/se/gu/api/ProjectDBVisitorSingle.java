...
public class ProjectDBVisitorSingle implements CommitVisitor {
    ...
    public ProjectDBVisitorSingle(ProjectData projectData, int commitIndex, List<String> commitHashes, DataController dataController) throws SQLException, ClassNotFoundException {
...
//            }
     ...
     //       if(commitIndex <startingCommitIndex){ //FIXME THIS DOESNT WORK FOR SINGLE COMMITS ATM
      //          return;
      //      }
