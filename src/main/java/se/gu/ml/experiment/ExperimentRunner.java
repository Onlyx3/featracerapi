    ...
    public void runExperiment() throws Exception {
        ...
        if (projectData.getConfiguration().isGenerateDatasetStatistics()) {
            ...
            if (projectData.getConfiguration().isCopyExpResultsToRFolder()) {
                ...
                FileUtils.copyFileToDirectory(new File(datasetStatFile), projectData.getConfiguration().getrDataFolder());//copy output to the Rfolder
            }
        }
...
//                System.out.println();
            ...
            if (projectData.getConfiguration().isCopyExpResultsToRFolder()) {
                ...
                if (projectData.getConfiguration().isRunCrossValidation()) {
                    ...
                    if(cvFile.exists()){
                        FileUtils.copyFileToDirectory(cvFile, projectData.getConfiguration().getrDataFolder());//copy output to the Rfolder
                    }
