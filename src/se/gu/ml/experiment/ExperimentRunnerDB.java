...
//reduce dataset
                ...
                if (projectData.getConfiguration().isCopyExpResultsToRFolder()) {
                    ...
                    if (psInstanceFile.exists()) {
                        FileUtils.copyToDirectory(psInstanceFile, projectData.getConfiguration().getrDataFolder());//copy output to the Rfolder
                    }
...
//                    }
                    ...
                    if (psMeasuresSummaryFile.exists()) {
                        FileUtils.copyToDirectory(psMeasuresSummaryFile, projectData.getConfiguration().getrDataFolder());//copy output to the Rfolder
                    }
